...
CREATE TABLE Ong(CIF VARCHAR(9) PRIMARY KEY, nom VARCHAR(20) NOT NULL, 
...
CREATE TABLE Socis_Ong(CIF_ONG VARCHAR(9), NIF_soci VARCHAR(9), 
PRIMARY KEY (CIF_ONG, NIF_soci), FOREIGN KEY (CIF_ONG) REFERENCES Ong(CIF),
FOREIGN KEY (NIF_soci) REFERENCES Soci(NIF));

CREATE TABLE Treballador(NIF VARCHAR(9) PRIMARY KEY, nom_cognoms VARCHAR(40) NOT NULL,
adresa VARCHAR(20) NOT NULL, poblacio VARCHAR(20) NOT NULL, comarca VARCHAR(20) NOT NULL,
...
CREATE TABLE Treballador_Voluntari(NIF VARCHAR(9) PRIMARY KEY, edat TINYINT NOT NULL,
professio VARCHAR(20) NOT NULL, hores TINYINT NOT NULL, FOREIGN KEY (NIF) REFERENCES Treballador(NIF));

CREATE TABLE Treballador_Professional(NIF VARCHAR(9) PRIMARY KEY, carrec VARCHAR(20),
